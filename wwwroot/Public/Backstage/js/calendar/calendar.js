...
// full month names
Calendar._MN = ['"' + January + '"', '"' + February + '"', '"' + March + '"', '"' + April + '"', '"' + May + '"', '"' + June + '"', '"' + July + '"', '"' + Aguest + '"', '"' + September + '"', '"' + October + '"', '"' + November + '"', '"' + December + '"'];

// short month names
Calendar._SMN = ['"' + Jan + '"', '"' + Feb + '"', '"' + Mar + '"', '"' + Apr + '"', '"' + May + '"', '"' + Jun + '"', '"' + Jul + '"', '"' + Agu + '"', '"' + Sep + '"', '"' + Oct + '"', '"' + Nov + '"', '"' + Dec + '"'];
